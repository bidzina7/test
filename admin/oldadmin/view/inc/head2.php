...
//'home/admin/domains/webdoors.ge/public_html/partners/hgn/' 
?>
 <?php
 //  $usr=mysqli_query($con,"SELECT t1.*,(SELECT name FROM userTypes WHERE  id=t1.type) AS tpname FROM users AS t1 WHERE t1.id='$uid'");
