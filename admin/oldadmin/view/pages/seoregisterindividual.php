...
$q=mysqli_query($con,"SELECT t1.*, 
									  ...
									  ". languages('seo','t1.id','keywords')  ." 
 								       ...
 								       FROM seo AS t1 WHERE   pagename='registerindividual'  ORDER BY t1.id DESC LIMIT 1");
if(mysqli_num_rows($q)<1)
{
	mysqli_query($con,"INSERT INTO seo SET pagename='registerindividual' ");
