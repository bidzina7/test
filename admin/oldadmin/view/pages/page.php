...
<input type="hidden" class="page" value="<?=$a?>"/>
	<div class="col-md-12">
		...
		<br>	
		<br>	
		<label><a target="_blank" href="http://kikalastudio.com/?page=<?=$a?>">View page Link</a></label>		
		<br>	
		<label>Show/hide</label>
		<input class="IN AC1" <?=$r1p["showhide"]==1?"checked":""?> n="showhide" type="checkbox"/>
		<br>
		<label>Show in main menu</label>
		<input class="IN AC2" <?=$r1p["menu"]==1?"checked":""?> n="menu" type="checkbox" />
		<br>
		<label>Page title</label>
		<input class="IN A1 form-control" n="titlegeo" value="<?=$r1p["titlegeo"]?>" placeholder="Page title" />
		<br>
...
?>			
	...
	?>
		...
		<div <?=$r1p["ptype"]==3?'style="display:block"':''?> class="PST"><br>
			...
			<br>
			<i>Post Text</i>
			<textarea  class="ADP" id="ADLP" ></textarea>
			<br>	
...
?>			
	...
	?>
		...
		<textarea  class="IN A3" n="textgeo" id="ADL1"><?=$r1p["textgeo"]?></textarea>
		</div>
		<br>
	</div>
	<br>&nbsp;
