<?php
$q="SELECT t1.*, ". languages('aboutus','t1.id','text')  ." ,  ". languages('aboutus','t1.id','title')  .", ".languages('aboutus','t1.id','description').", ".languages('aboutus','t1.id','keywords'). " FROM aboutus AS t1 ORDER BY t1.id DESC LIMIT 1";
...
$lng=mysqli_query($con, "SELECT id FROM langs WHERE shortname='".$lnshortarr[$z]."' AND tableName='aboutus' AND  tableColumn='text' AND tableId='".$dat['id']."' ");
        if(mysqli_num_rows($lng)<1)
   {
	   
	  
	   mysqli_query($con,"INSERT INTO langs SET shortname='".$lnshortarr[$z]."' , tableName='aboutus' , tableColumn='text' , tableId='".$dat['id']."'   ");
	   //echo "INSERT INTO langs SET shortname='".$lnshortarr[$z]."' , tableName='aboutus' , tableColumn='text' , tableId='".$dat['id']."'   ";
   }
	   
	   $lng1=mysqli_query($con, "SELECT id FROM langs WHERE shortname='".$lnshortarr[$z]."' AND tableName='aboutus' AND  tableColumn='title' AND tableId='".$dat['id']."' ");
        if(mysqli_num_rows($lng1)<1)
   {
	   
	  
	   mysqli_query($con,"INSERT INTO langs SET shortname='".$lnshortarr[$z]."' , tableName='aboutus' , tableColumn='title' , tableId='".$dat['id']."'   ");
	   //echo "INSERT INTO langs SET shortname='".$lnshortarr[$z]."' , tableName='aboutus' , tableColumn='text' , tableId='".$dat['id']."'   ";
   }
   $lng2=mysqli_query($con, "SELECT id FROM langs WHERE shortname='".$lnshortarr[$z]."' AND tableName='aboutus' AND  tableColumn='description' AND tableId='".$dat['id']."' ");
        if(mysqli_num_rows($lng1)<1)
   {
	   
	  
	   mysqli_query($con,"INSERT INTO langs SET shortname='".$lnshortarr[$z]."' , tableName='aboutus' , tableColumn='description' , tableId='".$dat['id']."'   ");
	   //echo "INSERT INTO langs SET shortname='".$lnshortarr[$z]."' , tableName='aboutus' , tableColumn='text' , tableId='".$dat['id']."'   ";
   }
   $lng2=mysqli_query($con, "SELECT id FROM langs WHERE shortname='".$lnshortarr[$z]."' AND tableName='aboutus' AND  tableColumn='keywords' AND tableId='".$dat['id']."' ");
        if(mysqli_num_rows($lng1)<1)
   {
	   
	  
	   mysqli_query($con,"INSERT INTO langs SET shortname='".$lnshortarr[$z]."' , tableName='aboutus' , tableColumn='keywords' , tableId='".$dat['id']."'   ");
	   //echo "INSERT INTO langs SET shortname='".$lnshortarr[$z]."' , tableName='aboutus' , tableColumn='text' , tableId='".$dat['id']."'   ";
   }
	   }
}
...
{
	mysqli_query($con, "INSERT INTO aboutus SET tel='0'");
}
?>
<div class="container">
...
<div class="itmcontainer" t='aboutus'  d="<?=$dat['id'] ?>">
    <div role="tabpanel">
        <!-- Tab panes -->
   ...
   ?>
        ...
        <div class="submit my-4">
            <button  class="btn btn-success ADDITEMS" t='aboutus' d="<?=$dat['id'] ?>">დამახსოვრება</button>
        </div>
       </div>
    </div>
</div>
