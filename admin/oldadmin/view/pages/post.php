...
echo 1;
	//echo "INSERT INTO articles (date,authorid) VALUES ('$T','$Guid') ";
	$ina=mysqli_query($con,"INSERT INTO articles (date,authorid) VALUES ('$T','$Guid') ");
...
<?php
$q2=mysqli_query($con,"SELECT t1.*, ". languages('categories','t1.id','name') ." FROM categories AS t1 WHERE t1.type IN(SELECT id FROM ctypes WHERE name='article') AND t1.active='1' ORDER BY t1.id DESC");
while($r2=mysqli_fetch_array($q2)){
?>
