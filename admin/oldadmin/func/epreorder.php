...
//add some data in excel cells
	...
	$q2=mysqli_query($con,"SELECT t1.*,  t3.quantity, t3.itemid, (SELECT name FROM stores as t4 where t1.place=t4.id) as storename FROM orders as t1  left join special as t2 on(t1.itemname=t2.ITEM) left join  qbystore as t3 on(t2.id=t3.itemid)  WHERE t1.status=8");
...
header('Content-Disposition: attachment;filename="Preordered.xlsx"');
