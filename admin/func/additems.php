...
$Guid=(int)$_SESSION['GuserID'];
	...
	if( $journaltype!=0)
	{
		//echo "INSERT INTO journal SET opertype=' $journaltype', uid='$Guid', opertype='$journaltype' ";
		mysqli_query($con,"INSERT INTO journal SET  uid='$Guid', text='$tex' ,opertype='$journaltype' ");
	}
